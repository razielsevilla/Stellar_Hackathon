...
- [x] Deployer account funded with real XLM
- [x] Contract logic reviewed for TTL expiry handling
- [x] Upgrade/admin keys secured and backed up
- [x] RPC provider selected and configured
